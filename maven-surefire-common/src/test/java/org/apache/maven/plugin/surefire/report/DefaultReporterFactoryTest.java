    ...
    extends TestCase
{
    ...
    public void testGetTestResultType()
    {
        ...
        assertEquals( unknown, DefaultReporterFactory.getTestResultType( emptyList, 1, 0 ) );

        List<ReportEntryType> successList = new ArrayList<ReportEntryType>();
        successList.add( ReportEntryType.SUCCESS );
        successList.add( ReportEntryType.SUCCESS );
        assertEquals( success, DefaultReporterFactory.getTestResultType( successList, 1, 0 ) );
        ...
        assertEquals( error, DefaultReporterFactory.getTestResultType( failureErrorList, 1, 0 ) );
        ...
        assertEquals( error, DefaultReporterFactory.getTestResultType( errorFailureList, 1, 0 ) );
